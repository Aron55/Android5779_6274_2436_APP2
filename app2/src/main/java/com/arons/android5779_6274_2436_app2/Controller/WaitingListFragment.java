...
import com.arons.android5779_6274_2436_app2.Model.location.GoogleLocation;
import com.arons.android5779_6274_2436_app2.Model.location.LocationHandler;
...
import static com.arons.android5779_6274_2436_app2.Model.Entities.Classes.ClientRequestStatus.IN_PROCESS;
...
public class WaitingListFragment extends Fragment {
    ...
    private void onLocationFound(){
        ...
        backend.notifyWaitingRidesList(new DBManager.NotifyDataChange<Ride>() {
    ...
    private void showCustomDialog(final Ride ride) {
        ...
        ((Button) dialog.findViewById(R.id.get_order_button)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                backend.updateClientRequestToDataBase(ride, new DBManager.Action() {
                    @Override
